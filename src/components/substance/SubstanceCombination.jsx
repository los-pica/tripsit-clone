...
import { substanceList } from "../../assets/data/SubstanceList";
//import CombinationResult from "../combination-result/CombinationResult";
...
const SubstanceCombination = () => {
  ...
  const onSubstanceClick = (id) => {
    ...
    let active = substances.filter((a) => a.active).map((obj) => obj.id);
